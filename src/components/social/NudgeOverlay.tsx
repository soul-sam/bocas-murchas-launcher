...
export function NudgeOverlay() {
  ...
  return (
    <>
      {lastNudge && (
        <div className="pointer-events-none fixed left-1/2 top-14 z-urgente -translate-x-1/2">
      ...
      {feedback && (
        <div className="acima-da-barra pointer-events-none fixed left-1/2 z-urgente -translate-x-1/2">
      ...
      {settings.nudgeOptOut && (
        <div
          ...
          className="acima-da-barra pointer-events-none fixed right-3 z-topo flex items-center gap-1 rounded-brutal border border-line bg-void/90 px-2 py-1 font-mono text-[11.5px] uppercase tracking-widest text-muted-foreground"
        >
